...
//     if (password.length < 6) return res.json({ errorMsg: "Password too short" });
...
//     if (!rf_token) return res.json({ errorMsg: "plz Login or register" });
...
//   try {
//     res.clearCookie("refreshtoken", { path: "/user/token" });
//     return res.json({ errorMsg: "logout success" });
//   } catch (err) {
